...
@Preview
@Composable
fun SharedTransitionPage4(model: MyModel = remember { MyModel().apply { selected = items[1] } }) {
...
class MyModel {
    val items =
        mutableListOf(
            Kitty("Waffle", R.mipmap.waffle, "American Short Hair", 0),
            Kitty("油条", R.mipmap.yt_profile, "Tabby", 1),
            Kitty("Cowboy", R.mipmap.cowboy, "American Short Hair", 2),
            Kitty("Pepper", R.mipmap.pepper, "Tabby", 3),
            Kitty("Unknown", R.drawable.question_mark, "Unknown Breed", 4),
            Kitty("Unknown", R.drawable.question_mark, "Unknown Breed", 5),
            Kitty("YT", R.mipmap.yt_profile2, "Tabby", 6),
        )
