package com.ethan.android.notepad.ui.media.picker
...
import com.ethan.android.notepad.ui.media.picker.page.MediaPickerPage
import com.skydoves.bundler.intentOf

class MediaPickerActivity : BaseActivityVBind<LayoutComposeContainerBinding>() {

    companion object {
        fun launch(context: Context) {
            context.intentOf<MediaPickerActivity> {
